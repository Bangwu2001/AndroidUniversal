"""
从smali文件中提取函数调用图,并转为family粒度的调用次数矩阵
一下代码均只操作于单个apk,单线程
"""
...
if __name__=="__main__":
    # import pickle
    # result=extract_Mama_family_feature_for_single_apk("三国.apk","data/depress")
    # with open("result1","wb") as f:
    #     pickle.dump(result,f)
    result = extract_Mama_family_feature_for_single_apk("fakeinst-38989f68945b8b0d8cabc460657d6900", "data/depress")
    # with open("result2", "wb") as f:
    #     pickle.dump(result, f)
    print(result)
    print(np.sum(result))
