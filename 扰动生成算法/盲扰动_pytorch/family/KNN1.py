...
#
# #保存权重
# joblib.dump(clf,"markov_classifier/KNN1")

clf=joblib.load("markov_classifier/KNN1")
# # res=clf.predict(train_data)
# # print(res.shape)
# # print(classification_report(train_label,res,target_names=["Malware","Benign"],digits=4))
#
...
train_data_path="iter_dataset/markov_evaluate_1000_X_sample_trainLoop2000_1_5000_selfDefined_v5"
train_label_path="iter_dataset/markov_evaluate_1000_Y_sample_trainLoop2000_1_5000_selfDefined_v5"
with open(train_data_path,"rb") as f:
    train_data=pickle.load(f)
with open(train_label_path,"rb") as f:
    train_label=pickle.load(f)
